...
from databaseManager import TaskManager
bot = TeleBot(TOKEN)
DATABASE = 'tasks.db'
task_manager = TaskManager(DATABASE)
task_manager.create_table("tasks","(id INTEGER PRIMARY KEY AUTOINCREMENT, task TEXT NOT NULL, desc TEXT, user_id INTEGER)")
